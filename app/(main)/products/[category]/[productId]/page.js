...
import ProductGallery from '@/app/(main)/components/productShow/ProductGallery/ProductGallery';
import './productShow.css';
import ProductDetails from '@/app/(main)/components/productShow/ProductDetails/ProductDetails';
import Button from '@/app/(main)/components/utils/button/Button';
import images from '@/app/public/assets/images';
import Link from 'next/link';
import Image from 'next/image';
import ProductReviews from '@/app/(main)/components/ProductReviews/ProductReviews';
import RelatedProducts from '@/app/(main)/components/RelatedProducts/RelatedProducts';
